...
<body>
   ...
   <div class="fourth-container" style="font-family:Georgia, 'Times New Roman', Times, serif ;">
    ...
    <div class="quote-container">
        <blockquote>
            <div class="text-wrapping"> <h3 class="text-dark">When it comes to serving face, we've got you covered. Whether you have a favorite brand or need help finding the perfect match,
                <i>Everglow Beauty</i> is your No.1 destination for everything beauty.</h3></div>
                <br>
    ...
    <div style="border: 2px dashed #ccc;">
      ...
      <div class="drop-container">
        ...
        <nav>
        <img id="lipstick" src="../img/armanilips.webp" alt="Lipstick" style="width:200px;
        padding:0px;" draggable="true" ondragstart="drag(event)">
        <img id="highlighter" src="../img/fentydiamond.webp" alt="Highlighter" style="width:200px;
        padding:2px;" draggable="true" ondragstart="drag(event)">
        <img id="blush" src="../img/charlotteblush.webp" alt="Blush" style="width:200px;
        padding:2px;" draggable="true" ondragstart="drag(event)">
        <img id="eyeshadow" src="../img/tartelette.webp" alt="Eyeshadow" style="width:200px;
        padding:2px;" draggable="true" ondragstart="drag(event)">
        <img id="lip liner" src="../img/charlottelips.webp" alt="Lip Liner" style="width:200px;
        padding:2px;" draggable="true" ondragstart="drag(event)">
        <img id="eyeshadoow" src="../img/kaja.webp" alt="Eyes" style="width:200px;
        padding:2px;" draggable="true" ondragstart="drag(event)">
    ...
    <div class="container d-flex footer-container">
        ...
        <div class="get-in-touch">
            ...
            <address style="margin-left: 100px; font-size: 20px; font-family:Georgia, 'Times New Roman', Times, serif;">
                <a id="adresa" href="https://maps.app.goo.gl/scmxnwzCazoUVT8b9">Address: Ferizaj</a> </address>
